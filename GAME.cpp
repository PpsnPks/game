...
void draw_status(){
    if (p.Mode == 2) {
        setcolor(6, 0);
        gotoxy(32 + ((p.Hard - 1) * 8), 7); printf(" Move = %d (%d)", p.Move,Ms);
    }
    if (p.Mode == 3) {
        setcolor(6, 0);
        gotoxy(32 + ((p.Hard - 1) * 8), 7); printf(" Move = %d (%d)", p.Move, Mi);
    }
    if (p.Mode == 1) {
        setcolor(6, 0);
...
void player_Win() {
    ...
    gotoxy(j + ((p.Hard - 1) * 4), i - 1 + ((p.Hard - 1) * 2)); printf("                            ");
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 5 ");
    gotoxy(j + ((p.Hard - 1) * 4), i + 1 + ((p.Hard - 1) * 2)); printf("                            ");
    Sleep(1000);
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 4 ");
    Sleep(1000);
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 3 ");
    Sleep(1000);
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 2 ");
    Sleep(1000);
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 1 ");
    Sleep(1000);
    gotoxy(j + ((p.Hard - 1) * 4), i + ((p.Hard - 1) * 2));     printf(" Y O U  ARE  W I N N E R! 0 ");
    Sleep(500);
    p.Money += (30*p.Hard);
    draw_status();
    setConsole(80, 30);
